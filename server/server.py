...
from ..constants import DTYPE_MAP, PUBLIC_INITIAL_PEERS
from ..data_structures import CHAIN_DELIMITER, UID_DELIMITER, ModelInfo, ServerInfo, ServerState, parse_uid
from .block_selection import *
from .backend import TransformerBackend, merge_inference_pools_inplace
from .block_utils import get_block_size, resolve_block_dtype
from .from_pretrained import load_pretrained_block
from .handler import TransformerConnectionHandler
from .memory_cache import MemoryCache
from .reachability import ReachabilityProtocol, check_direct_reachability, validate_reachability
from .throughput import get_dtype_name, get_server_throughput
from ..utils.auto_config import AutoDistributedConfig
from ..utils.convert_block import QuantType, check_device_balance, convert_block
from ..utils.dht import declare_active_modules, get_remote_module_infos
from ..utils.misc import get_size_in_bytes
from ..utils.ping import PingAggregator
from ..utils.random import sample_up_to
from ..utils.version import get_compatible_model_repo
...
class Server:
    ...
    def _choose_num_blocks(self) -> int:
        ...
        if self.adapters:
            # Delay import of ..utils.peft to avoid unnecessary import of bitsandbytes
            from ..utils.peft import estimate_adapter_memory_per_block
