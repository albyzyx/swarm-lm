...
from .utils.convert_block import QuantType
from .utils.version import validate_version
...
def main():
    ...
    parser.add_argument('--identity_path', default="swarm-lm-node/main.id", type=str, required=False, help='Path to identity file to be used in P2P')
    ...
    parser.add_argument("--skip_reachability_check", action='store_true',
                        help="Skip checking this server's reachability via health.swarmlm.xyz "
